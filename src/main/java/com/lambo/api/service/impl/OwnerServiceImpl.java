...
public class OwnerServiceImpl implements OwnerService {
    ...
    public List<OwnerDto> getAllOwners() {
        ...
        List<Owner> ownerList = owners.getContent();
        List<OwnerDto> content =  ownerList.stream().map(this::mapToDto).collect(Collectors.toList());

        OwnerResponse ownerResponse = new OwnerResponse();
        ownerResponse.setContent(content);
        ownerResponse.setPageNo(owners.getNumber());
        ownerResponse.setPageSize(owners.getSize());
        ownerResponse.setTotalElements(owners.getTotalElements());
        ownerResponse.setTotalPages(owners.getTotalPages());
        ownerResponse.setLast(owners.isLast());*/
